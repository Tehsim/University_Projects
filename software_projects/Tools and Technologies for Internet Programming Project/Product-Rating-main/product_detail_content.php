							...
							<form id="ratingForm" method="POST">
								...
								<div class="form-group">
									<label for="name">Name</label>
										<input type="text" class="form-control"  id = "reviewer" name="reviewer" placeholder="Username" value="<?php echo $userName ?>" required>
								</div>
								<div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<div class="login-help">
					<p><b>Username</b> sample: preetom, mary, lisa <b>Password</b>: 123</p>
				</div>
      </div>
